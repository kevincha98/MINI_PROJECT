...
<body>
    ...
    <style type="text/css">
        ...
        .fbox,.sbox,.tbox,.fbox,.dbox{height: 200px;width: 250px;background-color: #eee;margin-left: 15px;margin-top: 50px;box-shadow: inset 0 -3em 3em rgba(0,0,0,0.1),0 0 0 2px rgba(255,255,255,255),0.3em 0.3em 1em rgba(0,0,0,0.3) ;}
    ...
    <section class="feature_part">
        ...
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="">Volunteers Info</a>                                                 <!--SELECTION BUTTONS -->
            ...
            <div class="notification">
                <br>
                <span class="ti-arrow-circle-right"></span>&nbsp;&nbsp; <b></b> Donations Pending.<br><br>
                <span class="ti-arrow-circle-right"></span>&nbsp;&nbsp; <b></b> Volunteers are on Work.<br><br>
                <span class="ti-arrow-circle-right"></span>&nbsp;&nbsp; <b></b> Relief Centers are Active.
            </div>
